...
$('#delete-event').click(function () {
        ...
        var event_name = "event";//$event_name_selector.val();
        // var $event_description_selector = $('#event-description');
        var event_description = "deleted";//$event_description_selector.val();
        // document.write(event_description);
    ...
    $('#add-event').click(function () {
        ...
        if(existing_events) {
            alert("can't add more than one event on one day");
            return false;
...
function showCreateEvents() {
    ...
    if(events) {
        ...
        $.each(events, function (index, event) {
            event_lists = "<span class='event-name'>"+event.event_name+"</span>"+" <span class='event-description'>"+event.event_description+"</span><div></div>"
        });
